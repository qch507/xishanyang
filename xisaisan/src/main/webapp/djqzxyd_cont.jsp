...
<body>
	<div class="head_bj">
		...
		<div class="ty1100 mt35">
			<div>
				<img src="img/zbj_t.png" width="1100" height="29" />
			</div>
			<div class="zbj_c">
				<div>
					<img src="img/t5.png" width="310" height="77" />
				</div>
				<!--填写预订信息-->
				<form action="./order" method="post">
				<input name="pid" type="hidden" value="${pid }"/>
					<div class="bbs_ly">
						<div class="w500 txt_c">请填写您的预订信息：</div>
						<div class="w500 m10">
							<div class="txt01">您的称呼：</div>
							<input name="name" type="text" class="bd01" />
						</div>
						<div class="w500 m10">
							<div class="txt01">您的电话：</div>
							<input name="phone" type="text" class="bd01" />
						</div>
						<div class="w500 m10">
							<div class="txt01">您的要求：</div>
							<textarea name="comment" cols="" rows="" class="bd02"></textarea>
						</div>
						<div class="w500 m10">
							<div class="txt01">&nbsp;</div>
							<input name="" type="submit" class="bd03" value="提&nbsp;&nbsp;交" />
						</div>
					</div>
			...
			<div>
				<img src="img/zbj_b.png" width="1100" height="29" />
			</div>
		</div>
		<div class="b_bj">
			<div class="b_menu">
